# function _v2_get_intensity_near_field(problem::NonLinearOptics{PairCorrelation}, atomic_states, sensor; inelasticPart=true)
#     N = problem.atoms.N
#     r = problem.atoms.r
...
#     end
#     return real((Γ^2/4)*I_pairCorrelation)
# end

# function scattered_intensity(problem::NonLinearOptics{PairCorrelation}, atomic_states, sensor_positions; regime=:near_field, inelasticPart=true)
#     println("oi")
#     if regime == :far_field
...
#         r = problem.atoms.r
#         intensities = ThreadsX.map(eachcol(sensor_positions)) do sensor
#             _v2_get_intensity_near_field(problem, atomic_states, sensor; inelasticPart=inelasticPart)
#         end
#     else
